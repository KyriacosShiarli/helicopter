...
class Pool(list):
  ...
  @property #Propery is basically a getter that gets the property fitness. Thts why things that have @property will usually evaluate uppon return. They are variables wrapped in functions
  def fitness(self):
